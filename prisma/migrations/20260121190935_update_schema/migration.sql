/*
  ...
  - Added the required column `area` to the `orders` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "orders" ADD COLUMN     "area" TEXT NOT NULL,
